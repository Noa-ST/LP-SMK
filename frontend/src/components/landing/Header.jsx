                ...
                {navLinks.map((link) => (
                  <NavigationMenuItem key={link.name}>
                    <NavigationMenuLink 
                      href={link.href}
                      className={cn(
                        "px-4 py-2 text-sm font-bold transition-colors hover:text-accent rounded-lg text-primary"
                      )}
                    >
                      {link.name}
                    </NavigationMenuLink>
        ...
        >
          <div className="flex flex-col gap-8">
            ...
            <div className="mt-10 flex flex-col gap-4">
              ...
              <Button 
                variant="outline" 
                className="w-full h-14 border-2 border-primary text-primary font-bold text-lg rounded-2xl"
                onClick={() => window.location.href = '/login'}
              >
                Đăng nhập hệ thống
              </Button>
